...
// validate login
if ($email_exists && password_verify($_POST['password'], $users->password) && $users->status==1){
 
    // if it is, set the session value to true
    $_SESSION['logged_in'] = true;
    $_SESSION['user_id'] = $users->id;
    $_SESSION['access_level'] = $users->access_level;
    $_SESSION['firstname'] = htmlspecialchars($users->firstname, ENT_QUOTES, 'UTF-8') ;
