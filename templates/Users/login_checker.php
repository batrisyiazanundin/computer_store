<?php
// login checker for 'employee' access level
 
// if access level was not 'Admin', redirect him to login page
if(isset($_SESSION['access_level']) && $_SESSION['access_level']=="Admin"){
    header("Location: {$home_url}users/index.php?action=logged_in_as_admin");
}
...
// if it was the 'login' or 'register' or 'sign up' page but the customer was already logged in
    ...
    // if user not yet logged in, redirect to login page
    if(isset($_SESSION['access_level']) && $_SESSION['access_level']=="Employee"){
