...
// read products
    ...
    // select all query
    $query = "SELECT
                o.id, u.id, u.firstname, u.lastname, u.email, u.contact_number, u.address, u.password, u.access_level, u.access_code, u.status, u.created, u.modified
            FROM
                users u
                LEFT JOIN
                    orders o
...
function readOne(){
    ...
    $query = "SELECT
                u.id, u.firstname, u.lastname, u.email, u.contact_number, u.address, u.password, u.access_level, u.access_code, u.status, u.created, u.modified
            FROM
                users u
                LEFT JOIN
                    orders o
            ...
            FROM
                ...
                LEFT JOIN
                    orders o
                        ON o.id = u.id
            WHERE
                u.firstname LIKE ? OR u.lastname LIKE ? OR u.id LIKE ?
            ORDER BY
                u.id ASC";
